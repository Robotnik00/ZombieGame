...
public class OrientedBoundingBox
{
        ...
        public Vector4f intersects(OrientedBoundingBox bounds)
        {
                ...
                //System.out.printf("\n%f %f \n", projectedShape1[0].x, projectedShape1[0].y);
                //System.out.printf("%f %f \n", projectedShape2[1].x, projectedShape2[1].y);
        ...
        private Vector4f[] projectShape(Vector4f[] verts, Vector4f axis)
        {
                ...
                System.out.printf("p1 %f %f p2 %f %f\n", projectedPoints[0].x, projectedPoints[0].y, projectedPoints[1].x, projectedPoints[1].y);
